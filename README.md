...
проектом CMake или Visual Studio (либо в виде ссылки на онлайн Git-репозиторий).
Код должен компилироваться в GCC 6 или MSVC 2017.


Критерии оценки решения (все критерии важны в равной степени - нужно найти вариант решения, который будет максимально оптимален по всем трем):
